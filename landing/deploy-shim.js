...
(function () {
  ...
  /* --- Bù :focus-visible ---
     Trang này không khai :focus-visible và đặt outline:none, nên người dùng bàn
     phím không thấy mình đang ở đâu. CSS thật nằm trong khối đã nén, không sửa
     trực tiếp được; chèn ở đây vì shim chạy sau khi <html> bị thay. */
  (function () {
    var css = ':focus-visible{outline:2px solid var(--brand,#1d4ed8);' +
              'outline-offset:3px;border-radius:4px}' +
              'a:focus-visible,button:focus-visible,summary:focus-visible,' +
              '[tabindex]:focus-visible{outline:2px solid var(--brand,#1d4ed8);' +
              'outline-offset:3px}';
    function inject() {
      if (document.getElementById('__focus_fix')) return;
  ...
  var META = {"title": "SEOSONA UX-UI — Hệ thống thiết kế — token, component, quy tắc", "description": "28 component và hệ design token thuần HTML, CSS variable và Vanilla JS. Dán vào React, Next.js hay trang tĩnh đều chạy.", "url": "https://seosona-ux-ui.vercel.app", "image": "https://seosona-ux-ui.vercel.app/cover.jpg"};
